drop table if exists users, admins, organizations, news, locations, surveys, survey_options, survey_answers, events, comments, requests, responses, events_comments, news_comments, requests_comments, rating CASCADE;
...
(
    id          bigint generated by default as identity not null,
    author_id   bigint                                  not null,
    news_date   timestamp default current_timestamp     not null,
    location_id bigint,
...
(
    id                bigint generated by default as identity not null,
    author_id         bigint                                  not null,
    events_date       timestamp default current_timestamp     not null,
...
(
    event_id   bigint references requests (id),
    comment_id bigint references comments (id),
    primary key (event_id, comment_id)
);
